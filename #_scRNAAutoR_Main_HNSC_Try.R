...
##### Current path and new folder setting*  ##### 
  ...
  Version = paste0(Sys.Date(),"_","LN_HNSC")
  Save.Path = paste0(getwd(),"/",Version)
  dir.create(Save.Path)
  
  ## Import information
  InputFolder = "Input_files_GE" 
  InputAnno = "HNSC_Ano.csv"

  InputGSEA = "GSEA_Geneset_Pathway_3Database_WithoutFilter.txt"

##### Parameter setting* #####
  ClassSet1 = 1
  ClassSet2 = "classified  as cancer cell"
  ClassSet3 = "Lymph node"
...
##### Load datasets  #####
  ...
  ## Read 10x files
  scRNA_SeuObj.list <- ReadscRNA(InputFolder, list_files.df, Mode="GE")
